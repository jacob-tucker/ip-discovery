      ...
      <div className='w-full px-4 py-4'>
        ...
        <div className='bg-cardBg rounded-md border border-border p-4 mb-4'>
          <div className='flex justify-between items-start'>
            <div>
              ...
              <p className='text-sm font-medium'>IP ID: {decodedIpId}</p>
              {ipAsset && (
        ...
        <div className='mt-3 flex items-start'>
          ...
          <p className='text-xs text-textMuted'>
            Hover over nodes to see details. Click on a node to select it and
            see its data. Use the controls in the bottom left to zoom and reset
            the view.
          </p>
        </div>
      </div>
